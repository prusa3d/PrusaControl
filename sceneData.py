...
class AppScene(object):
    ...
    def automaticPositionOfModels(self):
        logging.info('Automatic placing of objects over scene')
...
class Model(object):
    ...
    """
    def __init__(self):
        logging.info('Init of new model')
        ...
        self.color = [randint(3, 8) * 0.1, randint(3, 8) * 0.1, randint(3, 8) * 0.1]
    ...
    def makeDisplayList(self):
        logging.info('Make display list')
...
class ModelTypeStl2(ModelTypeAbstract):
    def __init__(self):
        pass
